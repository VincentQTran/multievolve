...
def main():
    ...
    esm_zeroshot_sorted['wt'] = esm_zeroshot_sorted['mutations'].apply(lambda x: 1 if x[0] == x[-1] else 0)
    esm_zeroshot_sorted = esm_zeroshot_sorted[esm_zeroshot_sorted['wt'] == 0]
    ...
    esm_if_zeroshot['wt'] = esm_if_zeroshot['mutations'].apply(lambda x: 1 if x[0] == x[-1] else 0)
    esm_if_zeroshot = esm_if_zeroshot[esm_if_zeroshot['wt'] == 0]
